...
def plot(df_mean: pd.DataFrame, df_std: pd.DataFrame):
...
if __name__ == "__main__":
    df_mean, df_std = parse()
    # alternatively, directly load the data
